...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="headerWrapper">
        <div class="container">
            <a class="navbar-brand" href="home.php"> Platform For EV Enthusiasts</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-left">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="inner-page.html" id="navbarDropdown" role="button"
    ...
    <div>
        <div class="container text-center">
            <h1 class="mt-5 text-dark font-weight-dark">Platform For EV Enthusiasts</h1>
                ...
                <div class="media-body">
                    <p>
                        ...
                        while($q=mysqli_fetch_array($ques))
                        {
                            ...
                            print ("<u>Question:</u> <i style='color:darkblue;'>".$q['question']."</i><br/>  <i style='color:darkblue;'>Rating ".$q['rating']."</i><br/>");
                            print("</div>");
                            $ans=mysqli_query($conn,"SELECT answer,userid,rating FROM answers WHERE qid='$qid'");
                            while($a=mysqli_fetch_row($ans)){
                                print("<div class='right'>");
                                print ("<u>Answered</u> by <b>".$a[1]."</b>: <span><i>".$a[0]."</i></span><br> <span><i>"." Rating ".$a[2]."</i></span>");
                                print("</div>");
                                
                            }
                            $imgpath="EV".$count.".jpeg";
                           /* echo $imgpath;*/
                            ?>
                            <img src="<?php echo $imgpath ?>" alt="" width="600" height="400">
                            <?php
            ...
            <div class="container-lebal text-center text-md-center" style='color:white;wieght:10%;   font-size:0.13in;'>
                <div class="row">
                    <div class="col-md-6 mt-md-0 mt-6 text-left " style="margin-left:3%;" >
                        ...
                        <p>Email-Id's: sinchana@gmail.com<br />
                            <br> College: VVCE, Mysore</p>
                    </div>
                    ...
                    <div class="col-md-5 mb-md-0 mb-6 text-right" style="margin-right:2%;">
                        ...
                        <p>This website for EV Enthusiasts forum , where you can post your questions and get them
                            answered by fellow members of the EV Enthusiasts.</p>
                    </div>
                </div>
